                  ...
                  <td>
                    <div className="action-btns">
                      <button className="edit-btn" onClick={() => {
                        ...
                        setForm({ name: customer.name, email: customer.email, phone: customer.phone || "", password: "" });
                        setShowForm(true);
                      }}>✏️ Edit</button>
                      <button className="admin-btn" onClick={() => setRxCustomer(customer)}>👁️ View Prescription</button>
                      <button className="admin-btn" onClick={() => navigate(`/admin/prescription/add/${customer._id}`)}>📋 Add Prescription</button>
